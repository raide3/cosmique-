...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "UPDATE profils SET profession='$profession', lieu_residence='$lieu_residence', situation_familiale='$situation_familiale', description_physique='$description_physique', informations_personnelles='$informations_personnelles', photo='$photo' WHERE utilisateur_id = (SELECT id FROM utilisateurs WHERE pseudo = '$pseudo')";
...
<body>    
    ...
    <?php if ($profil['photo']) { ?>
            <p><strong>Photo:</strong> <img src="<?php echo htmlspecialchars($profil['photo']); ?>" alt="Photo de profil"></p>
        <?php } ?>
...
<body>
    ...
    <form action="profil.php" method="post">
        ...
        <input type="text" id="photo" name="photo" value="<?php echo htmlspecialchars($profil['photo']); ?>"><br>
